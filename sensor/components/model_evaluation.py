    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            if diff<self.model_eval_config.change_threshold:
                ...
                # Instead of raising Exception, return evaluation artifact with is_model_accepted=False
                model_eval_artifact = ModelEvaluationArtifact(is_model_accepted=False, improved_accuracy=diff)
